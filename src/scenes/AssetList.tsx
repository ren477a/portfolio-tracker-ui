  ...
  const assetList = assets.map((asset) => {
    ...
    return (
      <tr>
        ...
        <td>
          <span className="float-end">{asset.numOfShares}</span>
        </td>
        <td>
          <span className="float-end">{asset.buyPrice}</span>
        </td>
        <td>
          <span className="float-end">{amount.toFixed(2)}</span>
        </td>
        <td>
          <span className="float-end">{asset.brokerFee}</span>
        </td>
      </tr>
    );
  });
